...
const buttonVariants = cva(
  " inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium ring-offset-background focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "border-black border-[3px] bg-primary text-black hover:bg-primary/90 dark:border-white",
        destructive:
      ...
      size: {
        default:
          "h-10 px-8 py-6 hover:shadow-[10px_10px_0px_0px_rgba(0,0,0)] dark:hover:shadow-[10px_10px_0px_0px_rgba(255,255,255)] transition-all duration-300",
